...
public class ChannelList // : MonoBehaviour
{
    ...
    public static byte[] GetInitCommand(int nFactor, int channelsStim, int channelsLowFreq, int groupTime, int mainTime)
    {
        ...
        // Debug.Log(System.Convert.ToString (byte1, 2));
        // Debug.Log(System.Convert.ToString (byte2, 2));
        // Debug.Log(System.Convert.ToString (byte3, 2));
        // Debug.Log(System.Convert.ToString (byte4, 2));
        // Debug.Log(System.Convert.ToString (byte5, 2));
        // Debug.Log(System.Convert.ToString (byte6, 2));
